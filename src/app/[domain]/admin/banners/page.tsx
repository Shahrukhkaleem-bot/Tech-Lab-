    ...
    <>
      ...
      <BannerManager
        rows={(data ?? []).map((b) => ({
          ...
          desktopImageWidth: b.desktop_image_width,
          desktopImageHeight: b.desktop_image_height,
          mobileImageWidth: b.mobile_image_width,
          mobileImageHeight: b.mobile_image_height,
          showText: b.show_text,
